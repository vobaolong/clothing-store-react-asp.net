...
public class AdminCategoriesController(ISender sender) : BaseApiController
{
	...
	[HttpPost("bulk")]
	public async Task<IActionResult> CreateBulk([FromBody] BulkCreateCategoriesCommand request, CancellationToken ct)
	{
	...
	[HttpPut("bulk")]
	public async Task<IActionResult> BulkSetActive([FromBody] BulkSetActiveCategoriesCommand request, CancellationToken ct)
	{
	...
	[HttpPut("{id:guid}")]
	public async Task<IActionResult> Update(Guid id, CategoryUpsertDto request, CancellationToken ct)
	{
