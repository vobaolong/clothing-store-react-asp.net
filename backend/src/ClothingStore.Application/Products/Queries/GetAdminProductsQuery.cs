...
public record GetAdminProductsQuery(bool IncludeDeleted = false)
    : IRequest<IReadOnlyList<AdminProductResponseDto>>;
...
{
    public async Task<IReadOnlyList<AdminProductResponseDto>> Handle(
