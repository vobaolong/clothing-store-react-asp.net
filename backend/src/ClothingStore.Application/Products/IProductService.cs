...
public interface IProductService
{
    ...
    Task<IReadOnlyList<AdminProductResponseDto>> GetDeletedAsync(
        CancellationToken cancellationToken
    );
    Task<Guid> UpdateAsync(Guid id, AdminProductUpsertDto dto, CancellationToken cancellationToken);
    Task<AdminProductImportResultDto> ImportAsync(
    ...
    Task<int> BulkDeletePermanentAsync(
