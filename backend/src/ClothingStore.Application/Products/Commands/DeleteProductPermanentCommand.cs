...
public class DeleteProductPermanentCommandHandler(IProductService productService)
    : IRequestHandler<DeleteProductPermanentCommand>,
        IRequestHandler<BulkDeleteProductsPermanentCommand, int>
{
    public async Task Handle(
        DeleteProductPermanentCommand request,
    ...
    public async Task<int> Handle(
        BulkDeleteProductsPermanentCommand request,
        CancellationToken cancellationToken
    )
    {
