...
{
	public async Task<bool> Handle(ResendRegisterOtpCommand request, CancellationToken cancellationToken)
	{
		...
		await emailNotificationService.SendSafeAsync(user.Email, "Verify Your Email Address - Clothing Store", emailBody
, cancellationToken);
