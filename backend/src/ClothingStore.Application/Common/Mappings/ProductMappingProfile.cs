...
public class ProductMappingProfile : Profile
{
	public ProductMappingProfile()
	{
		...
		CreateMap<Product, ProductDto>()
				...
				.ForCtorParam(nameof(ProductDto.SalePriceStartDate), opt => opt.MapFrom(src => src.SalePriceStartDate))
				.ForCtorParam(nameof(ProductDto.SalePriceEndDate), opt => opt.MapFrom(src => src.SalePriceEndDate))
				.ForCtorParam(
