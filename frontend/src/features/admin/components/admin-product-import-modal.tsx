...
import { importAdminProducts, getAdminApiErrorMessage, type AdminProductImportResult } from '@/api/admin-api'
...
export default function AdminProductImportModal({
  ...
  return (
    <Modal
      ...
      okText='Import'
      cancelText='Đóng'
      okButtonProps={{ disabled: !selectedFile || isImporting, loading: isImporting }}
      destroyOnHidden={false}
      width={720}
    >
      <div className='space-y-4'>
        <Typography.Paragraph className='mb-0 text-sm text-gray-600'>
          Tải lên file .xlsx hoặc .xls. Mỗi dòng Excel đại diện cho một biến thể sản phẩm theo size/màu, không phải dữ liệu cấp sản phẩm.
          ...
          <div className='rounded-lg border border-gray-200 bg-gray-50 p-4'>
            ...
            {result.errors.length > 0 ? (
              <div className='mt-4'>
                ...
                <div className='max-h-64 overflow-auto rounded-md border border-red-200 bg-white'>
