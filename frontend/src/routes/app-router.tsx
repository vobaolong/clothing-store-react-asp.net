...
const PaymentReturnPage = lazy(() => import('@/features/checkout/pages/payment-return-page'))
const ProductDetailPage = lazy(() => import('@/features/products/pages/product-detail-page'))
