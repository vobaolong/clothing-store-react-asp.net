    ...
    <>
      ...
      {isOpen && (
        <div className="fixed z-50 bottom-24 right-6 w-105 max-w-[calc(100vw-2rem)] h-150 max-h-[calc(100vh-8rem)] bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-red-100 dark:border-gray-700 flex flex-col overflow-hidden">
          {/* Header */}
          <div className="flex items-center gap-3 px-5 py-4 bg-red-800 text-white shrink-0">
            <CustomerServiceOutlined className="text-2xl" />
            <div>
                ...
                {msg.loading ? (
                  <div className="flex items-start gap-2">
                    <div className="flex items-center justify-center w-8 h-8 bg-red-100 rounded-full shrink-0">
                      <CustomerServiceOutlined className="text-red-800 text-sm" />
                    </div>
                  ...
                  <div className="flex justify-end">
                    <div className="px-4 py-2.5 bg-red-800 text-white rounded-2xl rounded-br-sm max-w-[85%]">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      {msg.content && (
                        <div className="px-4 py-2.5 bg-gray-100 dark:bg-gray-800 rounded-2xl rounded-tl-sm max-w-[85%]">
                          <Text className="text-sm text-gray-800 dark:text-gray-200 whitespace-pre-wrap">
                            {msg.content}
                          </Text>
                        </div>
                      )}
                          ...
                          >
                            <div className="flex gap-3">
                              ...
                              <div className="flex-1 min-w-0">
                                <Text className="font-medium text-sm line-clamp-2 block">
                                  {product.name}
                                </Text>
                      ...
                      <div className="ml-10 space-y-2">
                        {msg.faqs.map((faq, i) => (
                          <Card
                            ...
                            className="rounded-xl! border-gray-200! dark:border-gray-700!"
                          >
                            <Text className="font-medium text-sm block">
                              ❓ {faq.question}
                            </Text>
                            <Text className="text-sm text-gray-600 dark:text-gray-400 block mt-1">
                              {faq.answer}
                            </Text>
                          </Card>
                        ))}
                      ...
                      <div className="ml-10 space-y-2">
                        {msg.shippingPolicy.map((policy, i) => (
                          ...
                          >
                            ...
                            <Text className="text-sm text-gray-600 dark:text-gray-400 block mt-1 whitespace-pre-wrap">
                              {policy.content}
                            </Text>
                          </Card>
                        ))}
                    ...
                    {msg.promotions && msg.promotions.length > 0 && (
                      <div className="ml-10 space-y-2">
                        {msg.promotions.map((promo, i) => (
                          ...
                          >
                            <Text className="font-semibold text-sm block text-amber-800 dark:text-amber-400">
                              🎉 {promo.code}
                            </Text>
                    ...
                    {msg.sizeRecommendation?.sizeGuide && (
                      <div className="ml-10">
                        ...
                        >
                          <Text className="font-medium text-sm block mb-2">
                            📏 Bảng size tham khảo
                          </Text>
