...
const AdminOrderDetailModal = lazy(
  () => import('@/components/admin/AdminOrderDetailModal')
)
const BannerModal = lazy(() => import('@/components/admin/BannerModal'))
const BulkCategoriesModal = lazy(() => import('@/components/admin/BulkCategoriesModal'))
const CategoryModal = lazy(() => import('@/components/admin/CategoryModal'))
const CouponModal = lazy(() => import('@/components/admin/CouponModal'))
