...
type AdminListFilterTree = {
	...
	treeData: Array<{ title: string; value: string; children?: AdminListFilterTree['treeData'] }>
	className?: string
	placeholder?: string
}
...
export type AdminListFilterControl = AdminListFilterSelect | AdminListFilterTree | AdminListFilterDateRange
